...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true){
            System.out.println("Do you want to Start the System? (Yes/No): ");
            String responseInput = scanner.next().trim().toLowerCase();

            if (responseInput.equals("yes")){
            ...
            } else if (responseInput.equals("no")) {
                System.out.println("System won't start.");
                scanner.close();
                return;
            }else {
